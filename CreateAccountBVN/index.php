      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="applicationsExamples">
            <ul class="nav ms-4">
              <li class="nav-item ">
                <a class="nav-link " href="../../userManagement/CreateAdmin.html">
                  <span class="sidenav-mini-icon"> W </span>
                  <span class="sidenav-normal">Create Admin</span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link " href="../../userManagement/CreateAggregator.html">
                  <span class="sidenav-mini-icon"> K </span>
                  <span class="sidenav-normal"> Create Aggregators </span>
                </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link " href="../../userManagement/CreateAgent.html">
                  <span class="sidenav-mini-icon"> W </span>
        ...
        <li class="nav-item">
          ...
          <div class="collapse " id="pagesExamples">
            <ul class="nav ms-4">
                ...
                <a class="nav-link " data-bs-toggle="collapse" aria-expanded="false" href="#AccountOpening">
                  ...
                  <div class="collapse " id="AccountOpening">
                    <ul class="nav nav-sm flex-column">
                      <li class="nav-item">
                        <a class="nav-link " href="../openAccountBVN/index.html">
                          <span class="sidenav-mini-icon text-xs"> N </span>
                          <span class="sidenav-normal"> Savings Account (bvn) </span>
                        </a>
                      </li>
                      <li class="nav-item">
                        <a class="nav-link " href="../openAccountNIN/index.html">
              ...
              <li class="nav-item">
                <a class="nav-link " href="../cardIssuance/index.html">
                  <span class="sidenav-mini-icon"> P </span>
    ...
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h3 class="font-weight-bolder mb-0 text-white">Savings Account (BVN)</h3>
        </nav>
        </div>
      </div>
    </nav>
