...
<head>
    ...
    <title>Agency Banking Platform</title>
</head>
<body>
    <div class="relative">
            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <div class="hidden ml-auto lg:flex lg:items-center lg:justify-center lg:space-x-10">
                        ...
                        <a href="#" title="" class="text-base font-semibold text-black transition-all duration-200 hover:text-opacity-80"> About </a>

                        <a href="#" title="" class="text-base font-semibold text-black transition-all duration-200 hover:text-opacity-80"> Services </a>

                        <a href="#" title="" class="text-base font-semibold text-black transition-all duration-200 hover:text-opacity-80"> Contact </a>

                        <a href="#" title="" class="inline-flex items-center justify-center px-5 py-2.5 text-base font-semibold transition-all duration-200 rounded-full bg-orange-500 text-white hover:bg-orange-600 focus:bg-orange-600" role="button"> Get Started </a>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="flex flex-col lg:flex-row lg:items-stretch lg:min-h-[800px]">
                <div class="relative flex items-center justify-center w-full lg:order-2 lg:w-7/12">
                    ...
                    <div class="relative px-4 pt-24 pb-16 text-center sm:px-6 md:px-24 2xl:px-32 lg:py-24 lg:text-left">
                        <h1 class="text-4xl font-bold text-black sm:text-6xl xl:text-6xl">
                        Smart Banking for Everyone, Everywhere.
                        </h1>
                        <p class="mt-6 text-xl text-black">Lukeport as a super agent gives you the platform to make quick and easy payments, and earn more.</p>
                        <button type="submit" class="inline-flex items-center justify-center w-full px-4 py-4 mt-4 font-semibold text-white transition-all duration-200 bg-orange-500 border border-transparent rounded-full sm:w-auto sm:ml-4 lg:ml-0 sm:mt-4 hover:bg-orange-600 focus:bg-orange-600">
                            Apply Now
                        </button>
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="max-w-xl mx-auto text-center">
            <h2 class="mt-6 text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Services</h2>
            <p class="mt-4 text-base leading-relaxed text-gray-600">Lukeport Agency Banking services are not limited to the underlisted services. It a robust platform that is very flexible for easy use.</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-5 mt-12 sm:grid-cols-3 lg:mt-20 lg:gap-x-12">
            <div class="transition-all duration-200 bg-white hover:shadow-xl">
                <div class="py-10 px-9">
                    ...
                    <h3 class="mt-8 text-lg font-semibold text-black">Account Opening</h3>
                    <p class="mt-4 text-base text-gray-600">With Lukeport Agency Banking, you can open account for more than 13 commercial banks and also earn great commission once the account is funded by the customer. Your customers get their account numbers immediately it is opened</p>
                </div>
            </div>
            ...
            <div class="transition-all duration-200 bg-white hover:shadow-xl">
                <div class="py-10 px-9">
                    ...
                    <h3 class="mt-8 text-lg font-semibold text-black">Card Issuances</h3>
                    <p class="mt-4 text-base text-gray-600">Open account for customers and issue ATM cards instantly to your customers right on the spot</p>
                </div>
            </div>
